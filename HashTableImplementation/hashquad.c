...
Copy( HashTable H, ElementType Array[] )
{
 ...
 /*
 All the ids from the hash table are copied 
 in an array, the array is sorted and then 
 according to the sorted ids the data from 
 the hash table is printed
 */    
void		
...
/*
The hash table is traversed, minimum id is found, its cell is marked is found and then
other ids are checked
*/	
void
